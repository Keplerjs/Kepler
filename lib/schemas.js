...
Climbo.schemas.conver = {
	title: '',         //Topic for the place wall or subject for the private convers
	placeId: '',       //se è null allora è una conversazione privata tra utenti
	userId: '',        //proprietario/mittente della conversazione
	usersIds: [],      //partecipanti alla conversazione, TODO rinomina in followers
	lastMsg: null
};

Climbo.schemas.converMsg = {
	updateAt: '',	
	convId: '',
	userId: '',
	body: ''
