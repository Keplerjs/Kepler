...
//TODO convert in JSON-SCHEMA

Kepler.schemas.place = {
...
Kepler.schemas.conver = {
	title: '',         //Topic for the place wall or subject for the private convers
	placeId: '',       //if null is a private users convers
	userId: '',        //owner/sender of conversation
	usersIds: [],      //convers participants users, TODO rename in followers
	lastMsg: null      //include last msg of conversation
};

Kepler.schemas.converMsg = {
	updateAt: '',	
	convId: '',
	userId: '',
	body: ''
