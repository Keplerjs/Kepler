...
Climbo.i18n = {
	...
	days_name: {"-1":"Ieri", "0":"Oggi", "1":"Domani"},
	times: {y:["anno","anni"], m:["mese","mesi"], d:["giorno","giorni"], h:["ora","ore"], i:["min","min"], s:["sec","sec"], ago:"fà"},
	times_short: {y:"y", m:"m", d:"d", h:"h", i:"m", s:"s"},
	words: {and: "e", from: "da", to: "a"},
	azimuth: [
		"Nord","Nord-NordEst","Nord-Est","Est-NordEst",
		"Est","Est-SudEst","Sud-Est","Sud-SudEst",
		"Sud","Sud-SudOvest","Sud-Ovest","Ovest-SudOvest",
		"Ovest","Ovest-SudOvest","Nord-Ovest","Nord-NordOvest","Nord"
	],
	azimuth_short: [
		"north","nne","ne","ene",
		"east","ese","se","sse",
		"south","ssw","sw","wsw",
		"west","wnw","nw","nnw","north"
	],
	errors: {
	...
	ui: {
		titles: {
			...
			pageConvers: "Conversazioni",
			pageNotifs: "Notifiche",
			pageConversUsers: "Conversazione privata",
			pagePlaceConvers: "Bacheca di {name}",			
			pageCheckins: "Climbers a",
			pageSectors: "Settori a"
		},
		alerts: {
			gpson: "I tuoi amici ora posso vedere la tua posizione!",
